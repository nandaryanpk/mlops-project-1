...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            skew_threshold = self.config["data_processing"]["skewness_treshold"]
    ...
    def select_features(self, df):
        try:
            ...
            logger.info("Features selected : {top_10_features}")
    ...
    def process(self):
        try:
            ...
            raise CustomException("Error while data preprocessing pipleline", e)
